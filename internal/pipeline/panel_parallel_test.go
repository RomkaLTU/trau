...
func TestPanelParallelMergedVerdictMatchesSequential(t *testing.T) {
	...
	seqVerdict, err := seq.runPanel(context.Background(), "COD-79701", "verify", "brief", "", "", "", "", "", "", "", "", false)
	if err != nil {
	...
	parVerdict, err := par.runPanel(context.Background(), "COD-79701", "verify", "brief", "", "", "", "", "", "", "", "", false)
	if err != nil {
...
func TestPanelParallelRunsConcurrently(t *testing.T) {
	...
	start := time.Now()
	v, err := p.runPanel(context.Background(), id, "verify", "brief", "", "", "", "", "", "", "", "", false)
...
func TestPanelParallelFatalMemberCancelsAndPropagates(t *testing.T) {
	...
	start := time.Now()
	_, err := p.runPanel(context.Background(), id, "verify", "brief", "", "", "", "", "", "", "", "", false)
	elapsed := time.Since(start)
