...
- Ask at the frontier. Map the open unknowns as a decision tree and pose only a question whose prerequisites are already settled; a question whose answer depends on another still-open question waits until that one is answered. Re-map after every answer — an answer often prunes whole branches and promotes a different question to the frontier.
