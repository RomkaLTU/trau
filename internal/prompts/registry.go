...
var registry = []Prompt{
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Branch", Description: "feature branch the work happens on", Required: true},
			{Field: "SkillsNote", Description: "rendered skills-loading sentence"},
			{Field: "Note", Description: "resume/lessons fragment"},
			{Field: "CodeStyle", Description: "rendered code_style fragment"},
			{Field: "BuildNotes", Description: "rendered build_notes fragment"},
			{Field: "TicketContext", Description: "injected ticket content block"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Handoff", Description: "QA brief file path the loop reads back", Required: true},
			{Field: "Rubric", Description: "rendered rubric fragment"},
			{Field: "TicketContext", Description: "injected ticket content block"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Verdict", Description: "JSON verdict file path the loop parses", Required: true},
			{Field: "Handoff", Description: "QA brief file path; empty switches to derive-from-ticket wording"},
			{Field: "Note", Description: "browser/app note"},
			{Field: "ChecksFragment", Description: "deterministic verify-checks fragment"},
			{Field: "RubricNote", Description: "rubric pointer note"},
			{Field: "LessonsNote", Description: "recalled-lessons note"},
			{Field: "TicketContext", Description: "injected ticket content block"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "RubricNote", Description: "rubric non-goals pointer note"},
			{Field: "Squash", Description: "true when the merge method is squash"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Verdict", Description: "JSON verdict file path", Required: true},
			{Field: "Branch", Description: "feature branch the work sits on", Required: true},
			{Field: "Fails", Description: "verdict failure lines", Required: true},
			{Field: "Handoff", Description: "QA brief file path; empty drops the brief reference"},
			{Field: "RubricNote", Description: "rubric pointer note"},
			{Field: "LessonsNote", Description: "recalled-lessons note"},
			{Field: "NotesNote", Description: "build-notes pointer note"},
			{Field: "CodeStyle", Description: "rendered code_style fragment"},
			{Field: "TicketContext", Description: "injected ticket content block"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "HookOutput", Description: "verbatim pre-push rejection output", Required: true},
			{Field: "NotesNote", Description: "build-notes pointer note"},
			{Field: "CodeStyle", Description: "rendered code_style fragment"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Base", Description: "branch being merged in", Required: true},
			{Field: "Branch", Description: "branch mid-merge", Required: true},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "EpicID", Description: "epic ticket id", Required: true},
			{Field: "PRURL", Description: "epic PR URL", Required: true},
			{Field: "Branch", Description: "epic integration branch", Required: true},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Path", Description: "JSON file path the loop parses back", Required: true},
			{Field: "Schema", Description: "exact JSON skeleton to fill", Required: true},
			{Field: "Result", Description: "experiment outcome"},
			{Field: "FailureType", Description: "classified failure type"},
			{Field: "Evidence", Description: "evidence lines"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Path", Description: "rubric JSON file path the loop reads back", Required: true},
			{Field: "Schema", Description: "exact rubric JSON shape", Required: true},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "Path", Description: "notes file path the mechanical phases read back", Required: true},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "ID", Description: "ticket id", Required: true},
			{Field: "Path", Description: "file path the loop parses the integer from", Required: true},
			{Field: "Files", Description: "changed file count"},
			{Field: "Additions", Description: "added line count"},
			{Field: "Deletions", Description: "deleted line count"},
			{Field: "Commits", Description: "commit count"},
		},
	...
	},
	{
		...
		Placeholders: []Placeholder{
			{Field: "Installed", Description: "installed skill names; empty falls back to self-selection"},
			{Field: "Required", Description: "required skill names, already intersected with Installed"},
		},
