...
| AI-authorship ban — "no mention of the loop or of any AI agent"; "do NOT add any 'Co-authored-by'… or any mention of AI/assistant authorship" | `build`, `commit`, `epic_repair` | Operator rule: trau's own repository and everything it publishes (commits, PR bodies) carry no AI signals. | Receipted (product rule) |
